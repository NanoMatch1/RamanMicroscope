...
#TODO: make custom decorator to return when testing is being performed, so specific responses can be asserted
...
def test_laser_power_cycle(sim_interface):
    ...
    laser_on = sim_interface._command_handler("laseron")
